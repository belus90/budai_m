...
public class DataLoader  implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        Shoe shoe1 = new Shoe("Air Jordan 1 Zoom CMFT","It simply doesn't get more classic than the Air Jordan 1. The shoe was brought to life by revered designer Peter Moore and premiered on the feet of Michael Jordan in the mid '80s. Readied in earth-inspired tones, the Air Jordan 1 Zoom CMFT.", 145,10,shoeType,"https://github.com/belus90/budai_m/blob/main/client/img/Men:Sports/2/2.2.jpeg?raw=true");
        shoeRepository.save(shoe1);
        Shoe shoe2 = new Shoe("Nike Pegasus Trail 3","Find your wings with an off-road run. The Nike Pegasus Trail 3 has the same comfort you love, with a design that nods to the classic Pegasus look.", 64,5,shoeType,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Men%3ASports/3/3.webp");
        shoeRepository.save(shoe2);
        Shoe shoe3 = new Shoe("Nike Air Max Alpha Trainer 4","Tackle your most intense workouts in the Nike Air Max Alpha Trainer 4. The wide, flat base with Nike Air cushioning gives you comfortable stability for lifting.Everything comes together in a durable shoe built for the rigours of the gym.", 59,20,shoeType,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Men%3ASports/4/4.webp");
        ...
        Shoe shoe6 = new Shoe("Clark's","Offering instant comfort thanks to the combination of a dual density footbed with Cushion Max™ technology and the premium leather linings and sock, these casual lace-up shoes are ideal for everyday wear.", 89,5,shoeType2,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Men%3ACasual/3/3.1.webp");
        ...
        Shoe shoe8 = new Shoe("Nike AIR MAX C","To celebrate the 35th anniversary of the iconic 'Air Max 1', Nike's latest iteration features a springtime-inspired colourway dubbed 'Light Madder Root'.", 56,15,shoeType5,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Women%3ASports/1/1.webp");
        shoeRepository.save(shoe8);
        Shoe shoe9 = new Shoe("Nike Air Force","The Nike Air Force 1 Low '07 LX UV Reactive displays a stem White composed of a mixture of leather textured and leather smooth.", 125,10,shoeType5,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Women%3ASports/2/2.webp");
        shoeRepository.save(shoe9);
        Shoe shoe10 = new Shoe("Nike Winfloo","The Nike Winflo 8 is a budget-friendly shoe that doesn’t offer a whole lot of versatility but for the price, it’s a solid choice. I would recommend this shoe to someone who is just getting into running.", 89,5,shoeType5,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Women%3ASports/3/3.webp");
        shoeRepository.save(shoe10);
        Shoe shoe11 = new Shoe("Nike Junifer Trail","A LIGHT AND TOUGH OFF-ROAD RUNNER.The Nike Juniper Trail delivers a consistent ride for your off-road runs. It's built for rocky trails, helping you stay focused on the path ahead.", 45,20,shoeType5,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Women%3ASports/4/4.webp");
        ...
        Shoe shoe12 = new Shoe("Madalena Balett shoe","Loafers are low-cut, lace-less shoes that were originally worn around the house by gentry and the royal family during the Summer time.", 34,15,shoeType7,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Women%3ACasual/1/1.webp");
        shoeRepository.save(shoe12);
        Shoe shoe13 = new Shoe("Leather Moccasin","Our Madolina leather moccasins make a sophisticated choice for even the most casual of settings. With soft suede uppers on lightweight soles, Madolina presents exemplary craftsmanship in a contemporary style.", 78,10,shoeType7,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Women%3ACasual/2/2.webp");
        shoeRepository.save(shoe13);
        Shoe shoe14 = new Shoe("Flat Leather Loafers","ASOS DESIGN has all the latest styles, featuring eye-catching embellishments from studs to oversized bows. Whether you're looking for flat sandals or ballet pumps, we've got just what you're after in our edit.", 89,5,shoeType7,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Women%3ACasual/3/3.webp");
        shoeRepository.save(shoe14);
        Shoe shoe15 = new Shoe("Begonia Leather Slip-On Shoes","As part of the brand's Comfort Collection, the leather footbed is equipped with cushioned zones across the heel and ball of your feet, to enhance your comfort.", 54,20,shoeType7,"https://raw.githubusercontent.com/belus90/budai_m/main/client/img/Women%3ACasual/4/4.webp");
